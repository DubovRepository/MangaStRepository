...
import { check } from '../fn/authentication-controller/check';
import { Check$Params } from '../fn/authentication-controller/check';
...
import { recoverAccount } from '../fn/authentication-controller/recover-account';
import { RecoverAccount$Params } from '../fn/authentication-controller/recover-account';
...
export class AuthenticationControllerService extends BaseService {
  ...
  /** Path part for operation `recoverAccount()` */
  static readonly RecoverAccountPath = '/auth/new-password-account';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `recoverAccount()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  recoverAccount$Response(params: RecoverAccount$Params, context?: HttpContext): Observable<StrictHttpResponse<AuthenticationResponse>> {
    return recoverAccount(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `recoverAccount$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  recoverAccount(params: RecoverAccount$Params, context?: HttpContext): Observable<AuthenticationResponse> {
    return this.recoverAccount$Response(params, context).pipe(
  ...
  static readonly CheckPath = '/auth/check-availability-account';
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  check$Response(params: Check$Params, context?: HttpContext): Observable<StrictHttpResponse<RegisterResponse>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  check(params: Check$Params, context?: HttpContext): Observable<RegisterResponse> {
