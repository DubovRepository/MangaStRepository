...
export class AdminManageComponent implements OnInit{
  ...
  testLoadMangaCategories() {
    this.mangaRequest.mangaCategories = this.editManga.categoryList as Category[];
    this.editManga.categoryList?.forEach((category) => {
